...
//Errors with loading keys.
if (result.error) {
  throw result.error;
}

//Getting keys from envionmental varaibles.
const pub_key = result.PUB_KEY;
const priv_key = result.PRIV_KEY;
const bearer = result.BEARER_TOKEN;
...
const consumer_key = pub_key; // Add your API key here
const consumer_secret = priv_key; // Add your API secret key here
